using System;
using System.Linq;
namespace prueda_de_escritorio
{
    class Program
    {
        ...
        static void Main()
        {
                ...
                Console.WriteLine("Introduzca el valor del menú en el que desea ingresar: " +
                    "" + "\n" + "[1] Contactos" + "\n" + "[2] Eventos" + "\n" + "[3] Utilitarios" + "\n" + "[4]salir");
                string cadenaEvaluar = Console.ReadLine();
                ...
                try
                {
                    hum = Convert.ToInt32(cadenaEvaluar);
                }
                catch (Exception)
                {
                    esNumer = true;
        ...
        static void Contacto()
        {
            int opciones = 0;
              ...
              "" + "\n" + "[1] Agregar" + "\n" + "[2] Actualizar" + "\n" + "[3] Borrar" + "\n" + "[4] Buscar" + "\n" + "[5]atras");
                ...
                try
                {
                    opciones = Convert.ToInt32(cadenaEvaluar);
                }
                catch (Exception)
                {
                    esNumer = true;
        ...
        static void UsToRd()
        {
            ...
            do
            {
                ...
                ulti = int.Parse(Console.ReadLine());
                switch (ulti)
                {
                    case 1: Utilitarios(); break;
                }
        ...
        static void Utilitarios()
        {
            ...
            try
            {
                opcion = Convert.ToInt32(cadenaEvaluar);
            }
            catch (Exception)
            {
                esNumer = true;
